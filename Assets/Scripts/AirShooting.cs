...
public class AirShooting : MonoBehaviour
{
    ...
    private void FireWindVolley(float baseRotationZ)
    {
        ...
        Quaternion centerRotation = Quaternion.Euler(0, 0, baseRotationZ + offset);
        Quaternion leftRotation = Quaternion.Euler(0, 0, baseRotationZ - spreadAngle + offset);
        Quaternion rightRotation = Quaternion.Euler(0, 0, baseRotationZ + spreadAngle + offset);
